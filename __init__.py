...
try:
    from ._rk import (
        _rk_json_load, _rk_json_dump, _rk_comfy_image_to_pil, _rk_pil_to_comfy_image,
        _rk_sam3_load_module, _rk_import_sam3_grounding, _rk_mask_bbox, _rk_import_sam3_loader,
        _rk_wordnet_parse_words, _rk_wordnet_clean_label, _rk_wordnet_new_branch, _rk_wordnet_insert_labels,
        _rk_wordnet_synset_label, _rk_wordnet_render_branch, _rk_wordnet_append_rendered_branch,
        _rk_wordnet_sorted_children, _rk_scene_caption, _rk_parse_aspect_ratio, _rk_snap_int,
        _rk_aspect_label, _rk_roka_cache_root, _rk_cache_safe_part, _rk_cache_path,
    )
except ImportError:
    from _rk import (
        _rk_json_load, _rk_json_dump, _rk_comfy_image_to_pil, _rk_pil_to_comfy_image,
...
try:
    ...
    from .images import NODE_CLASS_MAPPINGS as _IMAGE_NODE_CLASS_MAPPINGS
    from .images import NODE_DISPLAY_NAME_MAPPINGS as _IMAGE_NODE_DISPLAY_NAME_MAPPINGS
    from .svelte_preview import NODE_CLASS_MAPPINGS as _SVELTE_PREVIEW_NODE_CLASS_MAPPINGS
    from .svelte_preview import NODE_DISPLAY_NAME_MAPPINGS as _SVELTE_PREVIEW_NODE_DISPLAY_NAME_MAPPINGS
except ImportError:
    from frames import NODE_CLASS_MAPPINGS as _FRAME_NODE_CLASS_MAPPINGS
    from frames import NODE_DISPLAY_NAME_MAPPINGS as _FRAME_NODE_DISPLAY_NAME_MAPPINGS
    from cache import NODE_CLASS_MAPPINGS as _CACHE_NODE_CLASS_MAPPINGS
...
NODE_CLASS_MAPPINGS.update(_SVELTE_PREVIEW_NODE_CLASS_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(_SVELTE_PREVIEW_NODE_DISPLAY_NAME_MAPPINGS)
